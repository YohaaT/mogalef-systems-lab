// =============================================================================
// Strategy : COMB001_TREND_ES_5m
// Asset    : ES (E-mini S&P 500 Futures)
// Timeframe: 5-minute bars
// Phase B PF: (see backtest results)
...
{
    public class COMB001_TREND_ES_5m : Strategy
    {
        // =====================================================================
        // PARAMETERS
        // =====================================================================
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                BlockedWeekdays   = "1";          // Python 1 = Tuesday
                AtrMin            = 10.0;
                AtrMax            = 500.0;
                TargetAtrMult     = 7.0;
                TimeScanBars      = 35;
