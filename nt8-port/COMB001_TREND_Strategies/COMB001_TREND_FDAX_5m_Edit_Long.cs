// =============================================================================
// Strategy : COMB001_TREND_FDAX_5m
// Asset    : FDAX (DAX Futures)
// Timeframe: 5m bars
// Phase B PF: 3.10
...
{
    public class COMB001_TREND_FDAX_5m : Strategy
    {
        // =====================================================================
        // PARAMETERS
        // =====================================================================
        ...
        [NinjaScriptProperty]
        [Display(Name = "Only Longs", GroupName = "Trade Management", Order = 3,
            Description = "If true, only enter long trades (no shorts)")]
        public bool OnlyLongs { get; set; }
        ...
        [NinjaScriptProperty]
        [Range(1, 10)]
        [Display(Name = "Contracts", GroupName = "Trade Management", Order = 4,
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name                         = "COMB001_TREND_FDAX_5m";
                Description                  = "COMB_001_TREND ported from Python - FDAX 5-minute";
                ...
                // Default parameter values for FDAX 5m
                StpmtSmoothH      = 5;
                StpmtSmoothB      = 5;
                StpmtDistMaxH     = 25;
                StpmtDistMaxL     = 25;
                ...
                TrendR2           = 50;
                TrendR3           = 100;
                HoraireHours      = "13,14,15,16";
                BlockedWeekdays   = "1";          // 1 blocked
                AtrMin            = 20;
                AtrMax            = 200;
                TargetAtrMult     = 8;
                TimeScanBars      = 35;
                OnlyLongs         = false;        // Default: allow both longs and shorts
                StopQuality       = 3;
                StopRecentVolat   = 1;
                StopRefVolat      = 10;
                StopCoefVolat     = 5;
        ...
        protected override void OnBarUpdate()
        {
            ...
            else
            {
                ...
                // Filter conditions
                bool filtersPass = ComputeTrendFilter()
                    && IsHoraireAllowed()
                    && IsWeekdayAllowed()
                    && IsAtrAllowed();

                if (pose != 0 && filtersPass)
                {
                    atrAtEntry = ATR(14)[0];

                    // Determine if we should enter based on OnlyLongs parameter
                    ...
                    {
                        // Enter on both long and short signals
                        shouldEnter = (pose != 0);
                    }
