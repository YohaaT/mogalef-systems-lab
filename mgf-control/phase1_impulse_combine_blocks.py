"""Combine Phase 1 impulse optimization block results into unified output files."""
...
def combine_block_results():
    ...
    print("="*80)
    print("COMBINING PHASE 1 IMPULSE BLOCK RESULTS")
    print("="*80)
    ...
    for block_num in range(1, 6):
        block_log_file = f"phase1_impulse_optimization_block_{block_num}_log.csv"
        block_best_file = f"phase1_impulse_optimization_block_{block_num}_best_params.json"
    ...
    full_log_file = "phase1_impulse_optimization_full_log.csv"
    ...
    top_10_file = "phase1_impulse_optimization_top10.csv"
    ...
    best_params_file = "phase1_impulse_best_params.json"
    ...
    # Print summary
    print("\n" + "="*80)
    print("PHASE 1 IMPULSE OPTIMIZATION SUMMARY")
    print("="*80)
    ...
    print("\n" + "="*80)
    print("PHASE 1 IMPULSE OPTIMIZATION COMPLETE")
    print("="*80)
